...
comm=canu+' -p canu -d canu. genomeSize='+str(genomesize)+' corOutCoverage=5000 -nanopore-raw reads.fastq useGrid=false'
print (comm)
...
comm='mv canu./canu.trimmedReads.fasta canu.trimmedReads.fasta'
